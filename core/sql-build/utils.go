...
func GetWhereSetAnyValues(values interface{}, rule Rule) (value string,
	err error) {
	return getWhereSetAnyValues(values, rule, func(value string) string {
		return strings.Join([]string{"'", "'"}, string(value))
	})
}

func getWhereSetAnyValues(values interface{}, rule Rule, f func(value string) string) (value string,
	err error) {
