...
import (
	...
	"go-zero-study/tools/goctl/api/apigen"
	"go-zero-study/tools/goctl/api/dartgen"
	"go-zero-study/tools/goctl/api/docgen"
	"go-zero-study/tools/goctl/api/format"
	"go-zero-study/tools/goctl/api/gogen"
	"go-zero-study/tools/goctl/api/javagen"
	"go-zero-study/tools/goctl/api/ktgen"
	"go-zero-study/tools/goctl/api/new"
	"go-zero-study/tools/goctl/api/tsgen"
	"go-zero-study/tools/goctl/api/validate"
	"go-zero-study/tools/goctl/configgen"
	"go-zero-study/tools/goctl/docker"
	"go-zero-study/tools/goctl/feature"
	model "go-zero-study/tools/goctl/model/sql/command"
	rpc "go-zero-study/tools/goctl/rpc/command"
